...
public class KMeans
{
   ...
   *          clusters
   */
  private static void repartitionStep (PVector[] points, int k,
                                       PVector[] centroids, int[] repartition,
                                       Vector<PVector>[] clusters)
  {
   ...
   *          clusters
   */
  private static void centroidStep (PVector[] points, int k,
                                    PVector[] centroids,
                                    Vector<PVector>[] clusters)
  {
    for (int i = 0; i < k; i++) {
