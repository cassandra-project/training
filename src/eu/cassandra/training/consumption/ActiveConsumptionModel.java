 ...
 * 
 */
public class ActiveConsumptionModel
{
   ...
   */
  public ActiveConsumptionModel (String amodel)
  {
    model = amodel;
  ...
  /**
   * This function returns an array of the active consumption of the operation
   * of the appliance
   * 
   * @return an array of the active consumption through time.
   */
